...
Route::resource('components', 'Admin\ComponentAPIController');

Route::resource('data_sources', 'Admin\DataSourceAPIController');

Route::resource('data_queries', 'Admin\DataQueryAPIController');

Route::resource('data_columns', 'Admin\DataColumnAPIController');