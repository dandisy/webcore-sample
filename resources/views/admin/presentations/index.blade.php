...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
            <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('admin.presentations.create') !!}">Add New</a>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('admin.presentations.table')
            </div>
        </div>
    </div>
